...
public class APIEcommerce {
        private static final String API_KEY = "Anastasia"; // Ganti dengan API key Anda
        private static final int PORT = 8047;
        ...
        public static void main(String[] args) throws Exception {
            try {
                ...
                context.setHandler(APIEcommerce::handleRequest);
                server.start();
        ...
        private static JSONArray getUsersFromDatabase() throws SQLException {
            ...
            try (Connection connection = DbaseConnect.getConnection();
